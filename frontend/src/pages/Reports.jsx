    ...
    if (format === 'csv') {
      ...
      const drawPDF = (clientImgObj, sbImgObj) => {
        ...
        if (clientImgObj && clientImgObj.base64) {
          const maxWidth = 35; // Perfect for Portrait
          const maxHeight = 20;
        ...
        doc.text(title.toUpperCase(), centerX, 15, { align: 'center', maxWidth: 110 });
        ...
        doc.text(`Toilet ID: ${toiletIdStr}`, centerX, 28, { align: 'center', maxWidth: 110 });
