export const ioList = [
    // --- INPUTS ---
    { id: 1, name: 'PB Coin', type: 'Digital Input', voltage: '12V DC', description: 'Coin Push Button Signal' },
    ...
    { id: 3, name: 'PB Flush', type: 'Digital Input', voltage: '12V DC', description: 'Flush Push Button Signal' },
    { id: 4, name: 'Emergency Internal Push Button', type: 'Digital Input', voltage: '12V DC', description: 'Emergency Button Signal' },
    ...
    { id: 20, name: 'Emergency External Push Button', type: 'Digital Input', voltage: '12V DC', description: 'Spare Input Terminal 2' },
    ...
    { id: 14, name: 'Electronic Lighting Module', type: 'Digital Output', voltage: '230V AC', description: 'Toilet Light Control' },
    { id: 15, name: 'Exhaust Fan', type: 'Digital Output', voltage: '230V AC', description: 'Exhaust Fan Control' },
    { id: 9, name: 'Flush Valve', type: 'Digital Output', voltage: '12V DC', description: 'Flush Valve Control' },
    { id: 8, name: 'Strike Lock', type: 'Digital Output', voltage: '12V DC', description: 'Door Lock Control' },
